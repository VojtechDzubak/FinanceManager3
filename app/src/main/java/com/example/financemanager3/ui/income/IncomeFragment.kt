...
class IncomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.rv_income_transactions)
        ...
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(
            ...
            // Metoda pro vykreslení červeného pozadí
            override fun onChildDraw(
                ...
                val background = ColorDrawable(Color.RED) // Červená barva
